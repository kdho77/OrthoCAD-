...
function ScanPlaneSliceControls({ scanId }: { scanId: string }) {
    ...
    const ready = active && sliceDraft?.step === 2 && sliceDraft.previewLocal;
    ...
    return (
        <div className="space-y-1 rounded border border-sky-500/30 bg-sky-500/5 px-1.5 py-1.5 text-[10px] leading-snug">
            <p className="font-medium text-sky-200">Plane slice</p>
